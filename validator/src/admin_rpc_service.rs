    ...
    impl RpcHandler {
        ...
        fn start_with_config(config: TestConfig) -> Self {
            ...
            let meta = AdminRpcRequestMetadata {
                ...
                rakurai_config: Arc::new(RwLock::new(RakuraiConfig{rs_mode: RakuraiMode::Mode1, rs_cfg_d1: 40, rs_cfg_td2: 0, rs_cfg_ft3: 0, rs_cfg_sm4: 0.0, rs_cfg_fm5: 0, rs_cfg_nd6: 40})), 
            };
            let mut io = MetaIoHandler::default();
            io.extend_with(AdminRpcImpl.to_delegate());
