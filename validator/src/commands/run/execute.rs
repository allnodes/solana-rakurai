use {
    ...
    solana_core::{
        banking_stage::{
            ...
            transaction_scheduler::scheduler_controller::SchedulerConfig, RakuraiConfig,
            RakuraiMode,
        },
...
pub fn execute(
    ...
    if let Ok(rakurai_config_read) = rakurai_config.read() {
        info!(
            "Rakurai config | Mode: {:?}, D1: {:?}, D2: {:?}, D3: {:?}, D4: {:?}, D5: {:?}, D6: {:?}",
            rakurai_config_read.rs_mode,
            rakurai_config_read.rs_cfg_d1,
            rakurai_config_read.rs_cfg_td2,
            rakurai_config_read.rs_cfg_ft3,
            rakurai_config_read.rs_cfg_sm4,
            rakurai_config_read.rs_cfg_fm5,
            rakurai_config_read.rs_cfg_nd6
        );
    }
    ...
    let mut validator_config = ValidatorConfig {
        ...
        rakurai_config: rakurai_config.clone(),
        target_slot_adjustment_ms,
        tx_io_check,
        oms_connector,
        client_mode,
