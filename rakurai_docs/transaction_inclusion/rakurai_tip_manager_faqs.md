...
- [RevenueShareAccount structure](../rakurai_programs/programs/reward_distribution/README.md#56-revenueshareaccount--revenueshareaccountv1-structure) (TCA and MCA account layout in the Reward Distribution program)
...
4. **Settlement** — after the epoch ends, you transfer the agreed Rakurai share into the validator's **[Tips Collection Account (TCA)](../rakurai_programs/programs/reward_distribution/README.md#51-why-a-tips-collection-account-tca)**, following the same [tip distribution flow](#6-how-are-tips-distributed).
...
Both TCA and MCA use the on-chain **[RevenueShareAccount structure](../rakurai_programs/programs/reward_distribution/README.md#56-revenueshareaccount--revenueshareaccountv1-structure)**; recording timing differs between them (see below).
...
- **External custom tip accounts** — the external tip account holder must first **settle** their agreed share into the relevant [TCA](../rakurai_programs/programs/reward_distribution/README.md#51-why-a-tips-collection-account-tca). Once settled, commission is deducted (credited to Rakurai's account) and the remaining share is transferred to the validator identity account (with the option to convert it into block rewards).
- **MevShare (MCA)** — after the epoch ends, the searcher or transaction inclusion service **records** the owed revenue in the relevant [MCA](../rakurai_programs/programs/reward_distribution/README.md#52-why-a-mevshare-collection-account-mca) **once**, then **settles** it by transferring SOL into the MCA. Once settled, commission is deducted and the validator share is credited. For the full post-pack flow, see [MEV revenue sharing](./post_pack_confirmations.md#4-mev-revenue-sharing).
...
A: TCA and MCA use the [RevenueShareAccount structure](../rakurai_programs/programs/reward_distribution/README.md#56-revenueshareaccount--revenueshareaccountv1-structure) in the Reward Distribution program. For Tip Manager instructions and accounts, see the [Tip Manager program guide](../rakurai_programs/programs/rakurai_tip_manager/README.md).
