...
**Related:** [Quick start](./README.md#quick-start-get-enabled-on-tin) · [Post-pack confirmations](./post_pack_confirmations.md) · [Reward Distribution](../rakurai_programs/programs/reward_distribution/README.md)
...
- **Rakurai's eight tip accounts** — the Rakurai tip balance in the relevant [TCA](../rakurai_programs/programs/reward_distribution/README.md#3-tca--tips-for-landing-transactions) is transferred to the validator identity account (with the option to convert it into block rewards). If conversion is on, do not count the tip **and** the converted block reward — see [double-counting note](./README.md#2-note-do-not-double-count-tips-and-converted-block-rewards).
