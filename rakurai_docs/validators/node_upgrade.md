...
3. Download the [scheduler binary](./setup_and_build.md#33-download-the-scheduler-binary), authenticating it with your identity key.
4. Replace your old binary with the new one in the correct paths.
5. [Build and run](./setup_and_build.md#4-build-the-client) your validator, incorporating the scheduler binary you just downloaded.

---

## 2. Share diagnostics log after first leader turn

Please share the output of this command with rakurai team over slack/telegram after your first leader turn on a Rakurai validator:
