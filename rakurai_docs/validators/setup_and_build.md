...
Use the CLI to initialize your validator's [activation account](../rakurai_programs/programs/rakurai_activation/README.md). The following command returns a Pubkey (`RAKURAI_ACTIVATION_ACCOUNT_PUBKEY`), which is used in the [next step](#23-download-rakurai-scheduler-binary).
...
<a id="33-download-the-scheduler-binary"></a>
