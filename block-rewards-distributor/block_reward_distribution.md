...
Use the Rakurai Activation CLI [`update-commission`](../rakurai_docs/rakurai_programs/cli/README.md#34-update-commission) command:
...
You can also set commission at RAA creation time with `rakurai-activation init --block_reward_commission_bps <VALUE>`. See the [CLI README](../rakurai_docs/rakurai_programs/cli/README.md#32-init) for details.

Verify your settings anytime with [`rakurai-activation show`](../rakurai_docs/rakurai_programs/cli/README.md#35-show).
