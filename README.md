...
Rakurai-BAM v3.0.12 is available.
Here are some quick steps to get up and running:
...
It will default to `rakurai-jito` if not specified. Other available optons are `rakurai-bam` and `bam-strict-compliance`
